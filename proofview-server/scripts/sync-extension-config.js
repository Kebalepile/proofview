...
const configFile = path.join(extensionDir, "config.js");
...
function syncManifestHostPermissions(serverBaseUrl) {
  ...
  if (contentScript && Array.isArray(contentScript.js) && !contentScript.js.includes("config.js")) {
    contentScript.js = ["config.js", ...contentScript.js];
  }
